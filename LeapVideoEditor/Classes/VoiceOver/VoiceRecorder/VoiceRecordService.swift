...
final class VoiceRecordService {
    var audioVisualizationTimeInterval: TimeInterval = 0.1666667
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(VoiceRecordService.didReceiveMeteringLevelUpdate),
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(VoiceRecordService.didFinishRecordOrPlayAudio),
